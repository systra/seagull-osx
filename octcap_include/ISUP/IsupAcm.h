...
//  Revision: 
//            $Source: /ISUP/code/message/IsupAcm.h $
//            $Revision: 1.5 $
//            
//
//------------------------------------------------------------------------------
...
class IsupAcm : public IsupMsg
//
// = TITLE
// C++ encapsulation of an ISUP ACM (<{VERSION 2.0}>).
// 
// = DESCRIPTION
// This message class provides a specific interface to individually build and 
// access each parameter of an <[ACM message]>.
{
public:

  // = CONSTRUCTION

  IsupAcm(ISUP::MsgSetID);
  // This constructor builds an empty ACM message. The parameter <{P_msgSetId}>,
  // previously allocated by a call to <{IsupMgr::whichMsgSet()}>, must be 
  // passed. Therefore, the ACM as defined in the load metadata will
  ...
  // constructor, a call to <{IsupAcm::isValid()}> inspects the state of the
  // object.
  // From an implementation point of view, this constructor gets an instance
  // of a local representation of the ACM message.

  virtual ~IsupAcm();
  // This destructor deletes a ACM message. 

  static IsupAcm* castMsg(const IsupMsg* P_msg) ;
  ...
  // to get access to all the <{IsupAcm}> class accessors. If the message set
  // customization options are used, the same message set as the one used by
  // <{P_msgPtr}> will be used.

  IsupAcm(const IsupAcm& P_from);
  // The copy constructor provides a way to construct a ACM message and does
  ...
  // This method makes the new parameter <{P_parmName}> accessible via the <{IsupAcm}>
  ...
  // = SPECIFIC ACCESSORS
  // Accessors provide a generic facility for accessing ACM parameters. Each 
  ...
  IsupAcm* backwardCallIndicators(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* applicationTransport(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* ccnrPossibleIndicator(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* businessGroup(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* callReference(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* causeIndicators(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* connectedNumber(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* connectionRequest(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* informationIndicators(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* networkTransport(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* notificationIndicator(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* optionBackwardCallIndicators(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* redirectionInformation(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* userToUserIndicators(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* remoteOperations(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* transmissionMediumUsed(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  HPAIN::Boolean chargeInformationIsPresent(ISUP::MsgStatus& P_status) const;
  // Returns TRUE is the optional parameter <{chargeInformation}>
  // is present in message. Note that no write access is provided : only
  // the setting of a value activates the presence flag.

  void  chargeInformationSetAbsent(ISUP::MsgStatus& P_status);
  // Sets the optional parameter <{chargeInformation}> as absent
  // in the message. 

  ISUP::ParmValue* chargeInformation(ISUP::MsgStatus& P_status) const;
  // Provides read access to the <{chargeInformation}>
  // parameter.
  // The user must delete the <{ISUP::ParmValue}> object instance.

  IsupAcm* chargeInformation(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  // Provides write access to the <{chargeInformation}>
  // parameter. Setting a value activates the presence flag.
  // This methods does not delete the provided <{ISUP::ParmValue}> instance.

  // = chargeInformationType

  HPAIN::Boolean chargeInformationTypeIsPresent(ISUP::MsgStatus& P_status) const;
  // Returns TRUE is the optional parameter <{chargeInformationType}>
  // is present in message. Note that no write access is provided : only
  // the setting of a value activates the presence flag.

  void  chargeInformationTypeSetAbsent(ISUP::MsgStatus& P_status);
  // Sets the optional parameter <{chargeInformationType}> as absent
  // in the message. 

  ISUP::ParmValue* chargeInformationType(ISUP::MsgStatus& P_status) const;
  // Provides read access to the <{chargeInformationType}>
  // parameter.
  // The user must delete the <{ISUP::ParmValue}> object instance.

  IsupAcm* chargeInformationType(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  // Provides write access to the <{chargeInformationType}>
  // parameter. Setting a value activates the presence flag.
  // This methods does not delete the provided <{ISUP::ParmValue}> instance.
  ...
  IsupAcm* echoControlInformation(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* accessDeliveryInformation(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* redirectionNumber(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* parameterCompatibility(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* callDiversionInformation(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* networkSpecificFacility(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* serviceActivation(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* serviceActivation1995(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* redirectionNumberRestriction(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* conferenceTreatmentIndicator(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* uidActionIndicator(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* networkFunctionType(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* chargingAreaInformation(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* chargingInformation(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* chargingInformationType(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* mobileCommEndInfoTrf(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* mobileCommCallRef(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* additionalUserCategory(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* chargingInformationDelay(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* operatorInformationTransfer(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* userToUserInformation(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* accessTransport(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* genericNotification(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* unRecognizedParameter(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  IsupAcm* calledSubBasicServiceMarks(ISUP::ParmValue& P_val, ISUP::MsgStatus& P_status);
  ...
  friend ostream& operator<< (ostream& P_os, const IsupAcm& P_msg);
  // Do a pretty output on <{ostream}> of a reference to a <{IsupAcm}> instance.

  friend ostream& operator<< (ostream& P_os, const IsupAcm* P_msg);
  // Do a pretty output on <{ostream}> of a pointer to a <{IsupAcm}> instance.

private:

  // = CONSTRUCTION - INITIALIZATION

  const IsupAcm& operator=(const IsupAcm&);
  // The assignment is protected to prevent users from calling it

  static ISUP::InfoStatus init(HPAIN::Uint16 P_NumberOfMsgSet);
  // Ask to initialise the IsupAcm static data 

  static void end();
  // Ask to end with the IsupAcm static data 

  // = STANDARD MESSAGE MANAGEMENT
  
  static ISUP::InfoStatus installStdMsg(ISUP::MsgSetID P_msgSetId,
					HPAIN::Int32& P_tag);
  // Ask to support the standard message ACM which is belonging to
  // message set <{P_msgSetId}>.

  static const BF_MDMsg* getMsg(ISUP::MsgSetID P_msgSetId);
  // Ask the related BF reference of the ACM message.

  static HPAIN::Uint16 numberOfMsgSet;
  // number of message sets supported by this class.

  static const BF_MDMsg** relatedMsg;
  // Table containing the new ACM messages.

  static const BF_MDMsgElem*** relatedMsgElem;
  // Table containing the new parameters of the ACM messages.
...
// = EXAMPLE
//
// This example shows how a message ACM can be accessed.
//
// = BEGIN<CODE>
//
...
//
//  // IsupAcm is a standard derived class of IsupMsg
//  // This message has a new parameter : NEW_PARM
//  install = IsupAcm::installParm ("NEW_PARM", msgSetId, parmId);
//  if (!install->isOk()) exit(1);
//
//  IsupAcm* msgPtr = NEW IsupAcm(msgSetId);
