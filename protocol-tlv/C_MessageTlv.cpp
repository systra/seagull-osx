...
int C_MessageTlv::get_body_value (int P_id, int P_occurence,
                                      T_pValueData P_val,
                                      C_ProtocolTlv::T_pBodyValue P_body_val) {
    int L_occurence = P_occurence;
...
bool C_MessageTlv::set_body_value (int P_id, int P_occurence, T_pValueData P_val) {
...
int C_MessageTlv::set_body_value (int P_id, int P_occurence,
                                      C_ProtocolTlv::T_pBodyValue P_body_val,
                                      T_pValueData P_val) {
...
int C_MessageTlv::check_field_presence (int P_id, int P_occurence,
                                      C_ProtocolTlv::T_pBodyValue P_body_val) {
    int L_occurence = P_occurence;
    if (P_body_val->m_id == P_id)
      L_occurence--;
...
bool C_MessageTlv::check_field_presence (int              P_id, int P_occurence,
					    T_CheckBehaviour P_behave,
					    int              P_instance,
					    int              P_sub_id) {
  bool                                 L_ret   = true  ;
...
T_pValueData C_MessageTlv::get_field_value (int P_id, int P_occurence,
...
bool C_MessageTlv::get_field_value(int P_id,  int P_occurence,
                                   int P_instance,
                                   int P_sub_id,
